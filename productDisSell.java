...
/**
 * The display of the product that the user is selling.
 * Contains name,picture,price,quantity,comments button and cancel botton.
 * 
 * @author Daniel Wang
 * @version 2010/1/16
 */
...
public class productDisSell extends JFrame   
implements MouseListener,ActionListener,ItemListener
{
     ...
     */
    public productDisSell(String id){
        super("Product Page");
        setLayout(null);
    ...
    public void mouseClicked(MouseEvent e) 
    {
        if (e.getSource()==comment){
            commentSell app=new commentSell(productid);
